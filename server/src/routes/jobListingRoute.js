...
router.post("/create-job-listing", verifyToken, onlyEmployerAndAdmin, createJobListing);

// Route for updating job listing
router.put("/update-job-listing/:id", verifyToken, onlyEmployerAndAdmin, updateJobListing);

//Route for Deleting a job listing
router.delete("/delete-job-listing/:id", verifyToken, onlyEmployerAndAdmin, deleteJobListing);
